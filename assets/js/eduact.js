(function ($) {
  ...
  if ($(".main-menu__nav").length && $(".mobile-nav__container").length) {
    ...
    // Append Login button for mobile
    var loginBtn = document.createElement('a');
    loginBtn.href = 'login.html';
    loginBtn.className = 'eduact-btn mobile-login-btn';
    loginBtn.innerHTML = '<span class="eduact-btn__curve"></span><span data-i18n="login-btn">Login</span>';
    mobileNavContainer.appendChild(loginBtn);
  }
  ...
  // Language Switcher - Now handled by makeen-translations.js
  // This section has been moved to makeen-translations.js to prevent conflicts
