...
function switchToTab(tabId) {
	...
	console.log('Active tab button:', $(`.tab-button[data-tab="${tabId}"]`).length);
	console.log('Active tab content:', $(`#${tabId}`).length);
	...
	if (tabId === 'tab-2') {
		...
		initializeMOLDataStep();
	}
}

// Save and switch tab function
window.saveAndSwitchTab = function (targetTab) {
