...
// Resend Email (demo)
document.querySelector('.resend-email-link').addEventListener('click', function(e) {
  e.preventDefault();
  alert(currentLang === 'ar' ? 'تمت إعادة إرسال البريد الإلكتروني!' : 'Verification email resent!');
}); 